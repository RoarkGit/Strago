...
|`MOD_CATEGORY_ID`|The ID of the moderator channel category.                 |
|`MOD_CHANNEL_ID` |The ID of the moderator channel.                          |
|`DATABASE_URI`   |URI of MongoDB instance where data is stored.             |
